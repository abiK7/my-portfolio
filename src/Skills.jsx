    ...
    return (
        <section id="skillSection" className={`p-2.5 w-1/2 ${focusedSection==="skillSection"?"animateBorder":""}`} ref={skillRef}>
            ...
            <ul className="float-left text-xs">
                {core.map((skill) => (<li className="flex mb-1 border-b border-gray-200 py-2" key={skill.id}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#754add" className="size-4">
